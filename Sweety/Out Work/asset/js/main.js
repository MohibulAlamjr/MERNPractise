window.addEventListener("scroll",function(){
   ...
   "scale("+ eval(1+ parseFloat(parcentage/1000))+")"+
   "rotate("+(percentage/5)+" deg)";

   let astronout=document.querySelector(".astronout");
   astronout.style.transform = "rotate(" + (percentage / 10) + "deg)";
   astronout.style.right = (percentage / 10) + "%";
